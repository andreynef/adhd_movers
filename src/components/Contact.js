...
export default function Contact(props) {
  ...
  return (
    <Grid container direction={matchesMD?'column':null} alignItems={'center'} className={classes.mainContainer}>
      <Grid item container alignItems={'center'} className={classes.imgContainer}>
        <img src={businessCard} alt={'businessCard'} className={classes.img}/>
      </Grid>
